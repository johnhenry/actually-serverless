export async function RegisterSW(scope = "./") {
...
export async function WaitForSWReady() {
  // If there is no controller service worker, wait for up to 8seconds for the Service Worker to complete initialisation.
  if (navigator.serviceWorker && !navigator.serviceWorker.controller) {
    ...
    const timeout = RejectAfterTimeout(8000, "SW ready timeout");
